        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var results = await query
            ...
            .Select(signal => new
            {
                ...
                signal.Title,
                signal.Summary,
                signal.SummaryDigest,
                signal.SummaryDigestTruncated,
                signal.SummarySchemaVersion,
                signal.EnrichmentSchemaVersion,
                signal.SentimentNegative,
                signal.SentimentNeutral,
                signal.SentimentPositive,
                signal.VolatilityProbability,
                signal.SupplyBias,
                signal.SummarizedAt,
                signal.EnrichedAt,
                signal.Region,
