...
- Machine-verified TDD ledger now includes two strict test-first (`Level A`) chains across dashboard and core-service logic.
...
- Federated inference: semantic vectors pushed to agents via gRPC heartbeats.
- Dynamic risk management that balances availability and spot savings under event-driven volatility.
- Training via historical trace replay and backtesting (not synthetic market simulation).
...
- CP3407 assessment evidence matrix: docs/CP3407-Assessment-Evidence.md
